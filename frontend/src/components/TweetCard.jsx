      ...
      <CardContent className="p-5 flex items-start space-x-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center space-x-6 mt-4">
            ...
            <button className="flex items-center space-x-2 text-sm text-foreground-muted hover:text-primary transition-colors group/reply">
              <div className="p-1.5 rounded-full transition-colors group-hover/reply:bg-primary/10">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"></path></svg>
              </div>
              <span className="font-medium">{tweet.commentCount || 0}</span>
            </button>
